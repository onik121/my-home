        ...
        <Swiper modules={[Navigation, Pagination, A11y]}
            ...
            <SwiperSlide>
                <div className='slider-1 slider'>
                    <div className='overlay flex items-center justify-center'>
                        <div className='text-white text-center max-w-[700px] mx-auto'>
                            <h1 className='text-5xl'>Your Journey to the Perfect Residence Starts Here</h1>
            ...
            <SwiperSlide>
                <div className='slider-2 slider'>
                    <div className='overlay flex items-center justify-center'>
                        <div className='text-white text-center max-w-[700px] mx-auto'>
                            <h1 className='text-5xl'>Your Ultimate Guide to Residential Bliss</h1>
            ...
            <SwiperSlide>
                <div className='slider-3 slider'>
                    <div className='overlay flex items-center justify-center'>
                        <div className='text-white text-center max-w-[700px] mx-auto'>
                            <h1 className='text-5xl'>Finding Serenity in Every Space</h1>
            ...
            <SwiperSlide>
                <div className='slider-4 slider'>
                    <div className='overlay flex items-center justify-center'>
                        <div className='text-white text-center max-w-[700px] mx-auto'>
                            <h1 className='text-5xl'>Discover Your Dream Home Today!</h1>
